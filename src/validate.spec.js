import { validateAddParams, validateUpdateTitleParams } from "./validate";
...
describe('validateUpdateTitleParams', () => {
  it('should throw if ID is not convertible to number', () => {
    const params = ['alma', 'Todo', []];

    expect(() => validateUpdateTitleParams(params))
